...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        String[] filters = ContactType.getContactTypes();
        ...
        ArrayList<FilterContactTypeUi> filerContactsUi = new ArrayList<>();
        FilterContactTypeUi buttonAllOptions = createAllSelectedItem(filters);
        filerContactsUi.add(buttonAllOptions);
        for (String filter:
             filters) {
            filerContactsUi.add(createFilterContactType(filter));
        }
        ...
        filterContactTypesLiveDate.setValue(filerContactsUi);
    }
